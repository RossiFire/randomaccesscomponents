            ...
            <div className="container flex flex-col items-center justify-center h-full gap-20">
                ...
                <div ref={gridRef} className="group/grid grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FeatureCard
                        ...
                        icon={<React size="extra" className="absolute left-[65%] top-[10%] rotate-8 text-muted-foreground/20" />}
                    />
                    <FeatureCard
                        title="Customizable"
                        glowColor='#9b59b6'
                        description="Built on top of RadixUI and Shadcn/ui, for a standardized and customizable components."
                        icon={<RadixUI size="extra" className="absolute left-[65%] top-[10%] rotate-32 text-muted-foreground/20" />}
                    />
                    <FeatureCard
                        title="Animated"
                        glowColor='#FFDD01'
                        ...
                        icon={<Motion size="extra" className="absolute left-[70%] top-[10%] text-muted-foreground/20 dark:text-muted-foreground/20" />}
                    />
                    <FeatureCard
                        title="Accessible"
                        glowColor='#38bdf8'
                        description="Components are built to be fully accessible, with ARIA attributes and keyboard navigation."
                        icon={<TailwindCSS size="extra" className="absolute left-[70%] top-[10%] rotate-2 text-muted-foreground/20" />}
                    />
                </div>
            </div>
        </section>
