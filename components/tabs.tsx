...
export function Tabs({
	...
	return (
		<Unstyled.Tabs
			ref={ref}
			className={cn("flex flex-col overflow-hidden rounded-xl border bg-secondary my-4", className)}
			value={value}
...
export function TabsContent({
	...
	return (
		<Unstyled.TabsContent
			...
			forceMount
			className={cn(
				"p-4 text-[15px] bg-background rounded-xl outline-none prose-no-margin data-[state=inactive]:hidden [&>figure:only-child]:-m-4 [&>figure:only-child]:border-none",
				className
			)}
			{...props}
		>
