...
const QuickFormSimpleDemo: React.FC = () => {
	const { touched, errors, data, set, submit, isDirty, isValid, reset, toggleInArray } =
		useQuickForm({ email: "", username: "", isTosAccepted: false, interests: [] }, schema);
				...
				<div className="flex items-center justify-between">
					<div className="flex gap-2 items-center text-sm">
						...
						<div className="flex flex-col gap-1">
							<label htmlFor="isTosAccepted" className="text-sm">
								I accept fake terms and conditions
							</label>
