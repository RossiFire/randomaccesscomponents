...
const MarkeeDemo: React.FC = () => {
	...
	return (
		<DemoBlock
			className="m-0"
			containerClassName="flex flex-col items-center justify-center h-[400px]"
		>
			...
			<div className="mt-12 flex gap-6 flex-wrap w-full justify-center">
				<div className="flex items-center gap-2">
					<Checkbox
						id="fades"
						checked={showFades}
						onCheckedChange={() => setShowFades(!showFades)}
					/>
					<Label htmlFor="fades" className="text-sm text-muted-foreground font-normal">
						Fades
					</Label>
				</div>
				<div className="flex items-center gap-2">
					<Checkbox
						...
						onCheckedChange={() => setPauseOnHover(!pauseOnHover)}
					/>
					<Label htmlFor="pauseOnHover" className="text-sm text-muted-foreground font-normal">
						Pause on hover
					</Label>
				</div>
				<div className="flex items-center gap-2">
					<Checkbox id="paused" checked={paused} onCheckedChange={() => setPaused(!paused)} />
					<Label htmlFor="paused" className="text-sm text-muted-foreground font-normal">
						Paused
					</Label>
				</div>
				<Button
				...
				<div className="flex items-center gap-2">
					<Label htmlFor="duration" className="text-sm text-muted-foreground font-normal">
						Duration
					</Label>
					<InputGroup className="w-24">
						<InputGroupInput placeholder="Duration" value={duration} readOnly />
...
const MarkeeDemoWithGSAP: React.FC = () => {
	useGSAP(() => {
...
const MarkeeDemoWithFramerMotion: React.FC = () => {
...
export { MarkeeDemo, MarkeeDemoWithGSAP, MarkeeDemoWithFramerMotion };
