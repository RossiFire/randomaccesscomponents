---
title: Common Issues
description: Common issues you might encounter while using Random Access Components
---
...
like `ul`, `input`, `textarea`, etc., and all the components here are built on that principle.
...
If you've set specific linting rules for your project, you might encounter compile errors when copying the components,
so you may need to adjust the components accordingly.