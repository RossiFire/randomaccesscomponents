...
```typescript title="hooks/use-quick-form/useQuickForm.ts" icon="ts"
"use client";
...
```typescript title="hooks/use-quick-form/useQuickFormHistory.ts" icon="ts"
"use client";
...
```typescript title="hooks/use-quick-form/useQuickFormAnalytics.ts" icon="ts"
"use client";
