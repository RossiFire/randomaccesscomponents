---
title: Ripple
description: Add Ripple effect to everything — drop it inside any element for a smooth, cursor-tracking fill animation.
hot_item: true
---

<PageBadge badges={['tailwindcss', 'react', 'nextjs','gsap']} />
...
```tsx title="ripple.tsx" icon="react"
'use client';
