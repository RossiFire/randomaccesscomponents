...
<SingleCodeBlock icon={<React />} label="mouse-follow.tsx" lang="tsx">
```tsx
"use client";
...
### Basic
<SingleCodeBlock icon={<React />} label="page.tsx" lang="tsx">
...
<SingleCodeBlock icon={<React />} label="layout.tsx" lang="tsx">
```tsx
